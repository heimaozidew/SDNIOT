...
from mininet.links import Link, Intf, TCIntf, OVSIntf
...
class Node( object ):
    ...
    def setIP6(self, ip6,intf_str, prefixLen=64):
        self.cmd("ip addr add {}/{} dev {}".format(ip6,prefixLen,intf_str))
        self.ip6s[self]=ip6
    def IP6(self):
        return self.ip6s[self]
    ...
    def linkTo( self, node, link=Link,linktype='eth' ):
        """(Deprecated) Link to another node
           replace with Link( node1, node2)"""
        return link( self, node ,linktype=linktype)
...
class AP(OVSSwitch):
    pass
class APSensor(OVSSwitch):
    pass
class ZigSensor(OVSSwitch):
    pass
